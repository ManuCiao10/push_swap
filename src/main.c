...
1.1-If you find the biggest Number -1 push it and assign
...
+ Algorithm 5 Numbers : https://medium.com/@jamierobertdawson/push-swap-the-least-amount-of-moves-with-two-stacks-d1e76a71789a
